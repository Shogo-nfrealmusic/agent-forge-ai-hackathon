...
export const BOOKINGS: Booking[] = [
  ...
  // ---- Clear-weather bookings ------------------------------------------
  // A real calendar is mostly fine days. These exist so the triage list has
  // something realistic to filter: only a handful of the bookings below ever
  // need a weather decision.
  {
    ...
    longitude: 139.7737,
    durationMinutes: 60,
    plan: "Morning Portrait",
    customerName: "Demo Customer Eight",
    customerEmail: "demo-eight@example.com",
    customerPhone: "+15550107",
  },
  {
    ...
    longitude: 139.7967,
    durationMinutes: 60,
    plan: "Evening Street Shoot",
    customerName: "Demo Customer Nine",
    customerEmail: "demo-nine@example.com",
    customerPhone: "+15550108",
  },
  {
    ...
    longitude: 139.6993,
    durationMinutes: 60,
    plan: "Shrine Ceremony Shoot",
    customerName: "Demo Customer Ten",
    customerEmail: "demo-ten@example.com",
    customerPhone: "+15550109",
  },
  {
    ...
    customerEmail: "demo-eleven@example.com",
    customerPhone: "+15550110",
  },
];
